...
pub struct Generator<'a, 'b> {
    ...
    pub attributes_whitelist: Vec<fancy_regex::Regex>,
...
impl<'a, 'b> GeneratorBuilder<'a, 'b> {
    ...
    pub fn with_attributes_whitelist(mut self, attributes_whitelist: Vec<fancy_regex::Regex>) -> Self {
